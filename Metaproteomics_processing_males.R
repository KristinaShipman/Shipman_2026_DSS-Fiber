...
setwd("/Users/kristinasorokolet/Library/CloudStorage/Box-Box/Wright Lab Operations/Student Folders/Kris/KS_2/Proteomics/GLOBAL/RANDOM_BINS/MALES_CTABS/MS9_1P_75_unclus/")

df <- read_tsv("KS2_GBL_M_binned_ms9_1p.tsv")
meta <- read_csv("metadata.csv")  # must contain columns: SampleID, Group

write_xlsx(df, "KS2_GBL_M_binned_ms9_1p.xlsx")
...
ctab <- read_tsv("KS2_GBL_M_binned_ms9_1p_r_filtered75.tsv", show_col_types = FALSE)
